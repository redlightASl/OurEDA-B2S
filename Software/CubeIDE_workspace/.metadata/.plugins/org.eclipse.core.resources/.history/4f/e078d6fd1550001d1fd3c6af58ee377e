...
#ifndef PRINT_UART
#define PRINT_UART Console_UART
#endif
...
PUTCHAR_PROTOTYPE
{
	HAL_UART_Transmit(&PRINT_UART, (uint8_t *)&ch, 1, 0x0f);
	return ch;
}

//int fgetc(FILE *p)
//{
//  HAL_UART_Receive_DMA(&PRINT_UART, (uint8_t *)&p, 1);
//  while (__HAL_UART_GET_FLAG(&PRINT_UART, UART_FLAG_TC) == RESET);
//  // while(!(__HAL_UART_GET_FLAG(&PRINT_UART, UART_FLAG_TC))) {}
//  return ch;
//}
